...
Please make sure that you have [set up your user name and email address](https://git-scm.com/book/en/v2/Getting-Started-First-Time-Git-Setup) for use with Git. Strings such as `silly nick name <root@tang-it.cltwmwlnm2so.us-east-1.rds.amazonaws.com>` look really stupid in the commit history of a project.
